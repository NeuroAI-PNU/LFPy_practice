...
# https://nest-simulator.readthedocs.io/en/latest/auto_examples/brunel_alpha_evolution_strategies.html
"""
...
def simulate(parameters):
    ...
    nest.local_num_threads = parameters["local_num_threads"]
...
if __name__ == "__main__":
    simulation_parameters = {
        ...
        "local_num_threads": 30,  # number of threads used for simulation
    ...
    fig.savefig("brunel_alpha_evolution_strategies.png")
