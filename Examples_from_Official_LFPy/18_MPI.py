        ...
        if RANK == 0:
            ...
            for cellindex in range(self.POPULATION_SIZE):
                ...
                polycol = PolyCollection(zips,
                                         edgecolors='none',
                                         facecolors='bgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmykbgrcmyk'[
                                             cellindex],
            ...
            fig.savefig('18_mpi_plot.pdf', dpi=300)
            plt.show()
